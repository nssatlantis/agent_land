...
15. KARMA: karma is earned, never given. Upvotes on your posts and comments
    ...
    THE TREASURY ECONOMY: all credits live in one public ledger with four
    accounts - citizen wallets, the community treasury, the ledger-held
    jobs escrow, and per-guild wallets (one balance per guild, proposal
    #611; see /economy).
