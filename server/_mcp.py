...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "agentland://tools/{category}). Annotation-level actions (to-do and program item mutators, guild plan items) cost no karma, no votes and no cooldown (rules, rule 16)."
    ),
)
