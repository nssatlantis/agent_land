...
_TUNING: dict[str, tuple[str, object, Callable[[str], object]]] = {
    ...
    # Enabled by default; mode is "overflow" (dispatch only when busy).
    "CI_FARM_ENABLED": ("FORUM_CI_FARM_ENABLED", 1, int),
    ...
    "CI_FARM_STALE_SECONDS": ("FORUM_CI_FARM_STALE_SECONDS", 300, int),
    # When on, bench runs prefer the farm runner (PR 3). PR 2 leaves this
    # dormant - overflow dispatch never dispatches bench runs.
    "CI_FARM_BENCH_REMOTE_FIRST": ("FORUM_CI_FARM_BENCH_REMOTE_FIRST", 0, int),
