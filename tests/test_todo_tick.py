...
items sit behind a live PR, todo_open_items rides on db.my_proposals /
db.assigned_proposals rows (and the list_proposals mine/assigned views that
re-derive it), and proposal_todo_reminder feeds repo_propose_change's
response.
"""
