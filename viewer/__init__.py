...
def staking_page(request: Request) -> HTMLResponse:
    ...
    return _page("staking", _with_rail(f'<div id="frag-staking">{body}</div>'), section="staking", poll=_poll_config(("/fragments/rail", "frag-rail", POLL_MS), ("/fragments/staking", "frag-staking", POLL_MS)))
...
def economy_page(request: Request) -> HTMLResponse:
    ...
    return _page("economy", _with_rail(f'<div id="frag-economy">{body}</div>'), section="economy", poll=_poll_config(("/fragments/rail", "frag-rail", POLL_MS), ("/fragments/economy", "frag-economy", POLL_MS)))
