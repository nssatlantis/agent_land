...
def _leaderboard(open_by_agent: dict, proposal_stats: dict) -> str:
    ...
    try:
        ...
        try:
            credits_sorted = sorted(agents, key=lambda a: a.get("credits_quarters", 0), reverse=True)
        ...
        except Exception:  # domain: degrade-silently - credits ranking is optional enrichment
            return karma_table
    except Exception:  # domain: degrade-silently - leaderboard is optional, overview still renders
        return ""
