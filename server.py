...
def repo_propose_change(
    ...
    (vote_on_proposal) with net approvals at or above the community's
    threshold - FORUM_PROPOSAL_VOTE_THRESHOLD as a floor scaled with the
    census (rules rule 10; a threshold of 0 skips only the vote - the
